...
public class Inventory{  
   ...
   /**
    ...
    private static boolean argsOK(String[] args){
        if(args.length < 1){
            // System.out.println("Usage: java inventoryFile ");
            // System.out.println("  inventoryFile  file containing inventory updates "); 
            System.out.println("Usage: java program -[a|b] input_name_file output_name_file ");
            System.out.println("  -[a|b]            tree type (avl, bst) ");
            System.out.println("  input_name_file   file containing inventory ");
            System.out.println("  output_name_file  file to write tree string ");
            return false;
        }
        return true;
    }
